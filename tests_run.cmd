...
rem tests_run --level 5 --objects rigid --maximum 3
...
echo.
echo Usage examples:
echo   tests_run --level 5 --category ai --maximum 3
echo   tests_run --level 5 --category buildings --maximum 3
echo   tests_run --level 5 --category rigid --maximum 3
echo   tests_run --level 5 --category vehicles --maximum 3
echo   tests_run --level 5 --distinct-types --maximum 3
echo   tests_run --level 5 --distinct-categories --maximum 4
echo   tests_run --all-levels --category ai --maximum 1
exit /b 2
