// Level-walking wrapper for light-fixture extraction (#63). Split from
// light_fixture_extract.cpp so the pure clustering logic (ProposeFixtures)
// stays unit-testable without linking the renderer stack.
#include "../pch.h"
