...
|---------|--------------|--------|----------------|
| **3.6.8-pre** | 2026-08-25 | Pre-release | Win32 IGI1/location0 MCP server over stdio and loopback HTTP; validated game-data edits, revision-safe transactions, and cross-family ATTA dependency fixes |
