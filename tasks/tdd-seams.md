...
| `WindowInputRouter` / `RuntimeWorld` / `RuntimeRenderer` | Grounded map-computer rising-edge toggle, held-key suppression, six-row objective snapshot, and immutable HUD presentation data. |
