...
| `WindowInputRouter` / `RuntimeWorld` / `RuntimeRenderer` | Grounded map-computer rising-edge toggle, held-key suppression, player input freeze while open, six-row objective snapshot, and immutable HUD presentation data. |
